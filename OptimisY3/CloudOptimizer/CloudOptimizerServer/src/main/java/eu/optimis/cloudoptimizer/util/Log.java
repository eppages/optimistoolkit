...
package eu.optimis.cloudoptimizer.util;
 ...
 */
public class Log {
    public static final String LOG4J_CONFIG_FILE_PATH = System.getenv("OPTIMIS_HOME") + "/etc/CloudOptimizer/log4j.properties";
