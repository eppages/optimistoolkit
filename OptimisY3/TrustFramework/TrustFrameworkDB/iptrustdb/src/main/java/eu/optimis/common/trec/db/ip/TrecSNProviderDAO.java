...
import eu.optimis.trec.common.db.ip.model.SnProvider;
import eu.optimis.trec.common.db.ip.model.SnProviderId;
...
public class TrecSNProviderDAO {
	...
	public boolean deleteIP(String providerId, String providerType) throws Exception {
		Session session = null;
		SessionFactory sf = HibernateUtil.getSessionFactory();
		int result = 0;
		try {
