...
public class VMHMInformation {
	...
	public VMHMInformation(String serviceId, String vmId, String virtualResourceId){
	...
	public void printContent(){
		...
		log.debug("virtual resource id: "+virtualResourceId);
		log.debug("cpu usage: "+cpu_usage);
		log.debug("cpu asked: "+cpu_asked);
		log.debug("cpu allocated: "+cpu_allocated);
		log.debug("memory used: "+memory_used);
		log.debug("memory asked: "+memory_asked);
		log.debug("memory allocated: "+memory_allocated);
		log.debug("disk asked: "+disk_asked);
		log.debug("disk allocated: "+disk_allocated);
		log.debug("disk used: "+disk_used);
		log.debug("num cpu asked: "+num_cpu_asked);
		log.debug("num cpu allocated: "+num_cpu_allocated);
	}
