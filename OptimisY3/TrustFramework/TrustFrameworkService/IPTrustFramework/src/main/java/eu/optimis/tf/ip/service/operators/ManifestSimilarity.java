...
//        System.out.println("componentNumberSimilarity " + componentNumberSimilarity);
        affinitySectionSimilarity=Math.pow(affinitySectionSimilarity,2);
//        System.out.println("affinitySectionSimilarity " + affinitySectionSimilarity);
        trustLevelSimilarity=Math.pow(trustLevelSimilarity,2);
//        System.out.println("trustLevelSimilarity " + trustLevelSimilarity);
        riskLevelSimilarity=Math.pow(riskLevelSimilarity,2);
//        System.out.println("riskLevelSimilarity "+riskLevelSimilarity);
        ecoLevelSimilarity=Math.pow(ecoLevelSimilarity,2);
//        System.out.println("ecoLevelSimilarity " + ecoLevelSimilarity);
        costPlancapSimilarity=Math.pow(costPlancapSimilarity,2);
//        System.out.println("costPlancapSimilarity "+ costPlancapSimilarity);
        costPlanfloorSimilarity=Math.pow(costPlanfloorSimilarity,2);
//        System.out.println("costPlanfloorSimilarity " + costPlanfloorSimilarity);
        dataProtectionSimilarity=Math.pow(dataProtectionSimilarity,2);        
//        System.out.println("dataProtectionSimilarity "+dataProtectionSimilarity);
    ...
    public List<HashMap> lhm2list(LinkedHashMap<String,Double> lhm){
