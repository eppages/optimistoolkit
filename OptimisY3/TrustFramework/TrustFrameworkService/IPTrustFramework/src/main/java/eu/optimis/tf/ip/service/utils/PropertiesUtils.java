...
public class PropertiesUtils {
	...
	private static Logger log = LoggerFactory.getLogger("eu.optimis.tf.ip.service.utils.PropertiesUtils");

	private static final String OPTIMIS_CONFIG_FILE = "/etc/optimis.properties";
	private static final String TRUST_CONFIG_FILE = "/etc/iptf/config.properties";
	private static final String LOG4J_CONFIG_FILE = "/etc/iptf/log4jTRUST.properties";

	private static final String OPTIMIS_CONFIG_FILE_WIN = "\\etc\\optimis.properties";
	private static final String TRUST_CONFIG_FILE_WIN = "\\etc\\iptf\\config.properties";
	private static final String LOG4J_CONFIG_FILE_WIN = "\\etc\\iptf\\log4jTRUST.properties";
