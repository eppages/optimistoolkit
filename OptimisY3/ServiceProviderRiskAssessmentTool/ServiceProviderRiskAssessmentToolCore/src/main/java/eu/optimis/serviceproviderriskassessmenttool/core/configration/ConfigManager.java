 ...
 */
package eu.optimis.serviceproviderriskassessmenttool.core.configration;
...
public class ConfigManager {
    ...
    public static final String IPRA_CONFIG_FILE = "/etc/ServiceProviderRiskAssessmentTool/spraconfig.properties";
    public static final String LOG4J_CONFIG_FILE = "/etc/ServiceProviderRiskAssessmentTool/log4jSPRA.properties";
    ...
    private static void createDefaultConfigFile(File fileObject) throws Exception{
        log.info("SPRA: File " + fileObject.getAbsolutePath() + " didn't exist. Creating one with default values...");
