...
/**
 * The purpose of this class is for the storing of various settings. It encapsulates
 * the properties class and allows for easy access to multiple different types.
...
public class Settings {
    ...
    /**
     * This removes the setting with the given name from the settings file.
     * It does not write the effect of this out to disk.
    ...
    /**
     * This retrieves a setting from the list, if it is not set already then
     * the default value is set
     * @param name The name of the setting to return.
     * @param defaultVal The default value to set in case no value is able to
     * be returned.
     * for the given parameters name.
     * @return The value of the returned setting.
     */
    ...
    public void load(File file) {
        try {
            if (file.exists()) {
                ...
                BufferedInputStream buff = new BufferedInputStream(strm);
                settings.load(buff);
                buff.close();
                strm.close();
                changed = false;
    ...
    /**
     * This sets the file description that is held at the top of a settings
     * file when it is sent to disk.
