...
public class ConfigManager {
    ...
    public static final String MMEB_CONFIG_FILE = "/etc/MonitoringManagerWeb/mmweb.properties";
    public static final String LOG4J_CONFIG_FILE = "/etc/MonitoringManagerWeb/log4j.properties";
