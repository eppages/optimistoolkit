...
import eu.optimis.mi.gui.client.userwidget.graph.GraphicReportPanel;

public class GraphicReportView extends View {
	
	private ContentPanel graphicReport;
	public GraphicReportView(Controller controller) {
		super(controller);
	...
	private void initUI(){
		graphicReport = new GraphicReportPanel();
