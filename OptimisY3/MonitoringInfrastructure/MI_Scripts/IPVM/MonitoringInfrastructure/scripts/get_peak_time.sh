...
#
# Description:
# Compute peak time of previous day based on Downstream and Upstream figures
# stored in the Monitoring database.
#
###

TMP=/tmp/$$
BASEDIR=`echo $0 | sed "s/\/get_peak_time\.sh//"`
source $BASEDIR/../share/database.properties
source $BASEDIR/get_peak_time.properties
...
echo "ORDER BY timesum DESC"                                                                        >> $TMP.$NODE
...
"<metric_name>peak_time</metric_name>"\
