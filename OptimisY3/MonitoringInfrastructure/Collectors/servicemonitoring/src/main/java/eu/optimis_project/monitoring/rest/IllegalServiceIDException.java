...
public class IllegalServiceIDException extends WebApplicationException {
    ...
    public IllegalServiceIDException() {
        this("Illegal service-ID parameter");
    }

    /**
     * Create a HTTP 400 (Bad request) exception with a specific fault
     */
    public IllegalServiceIDException(String message) {
