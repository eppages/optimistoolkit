...
class MigrationBeforePlacement extends AbstractPlacement {

    // TODO: quantify migration cost
    public MigrationBeforePlacement(String nodeId, EmotiveOVF vmInfo, PlacementOptimizer po) {
