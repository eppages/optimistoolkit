 ...
 * @author jsubirat
 */
public class InteroperabilityTestONE extends TestCase {

    public InteroperabilityTestONE(String testName) {
        super(testName);
    }
    ...
    public void testVMCreationDestruction() {
        try {
            ...
            OVFWrapper ovfDom = OVFWrapperFactory.create("VMManagerInteroperabilityTestVM",
                    1,
                    512,
                    new OVFDisk[]{new OVFDisk("base", "centos_15g_x86_64.qcow2", 0L),
                                    new OVFDisk("context", "testingContestIso.iso", 0L)},
                    new OVFNetwork[]{},
