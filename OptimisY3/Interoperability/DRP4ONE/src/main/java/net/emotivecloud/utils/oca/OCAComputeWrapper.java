 ...
 * info() method, that is an object obtained "deserializing" the XML
 * file
 *
...
public class OCAComputeWrapper implements VmType{
    ...
    /**
     * Return a String containing the XML source without any null
     * elements
     * @return String containing the XML source without any null
     * elements
     */
