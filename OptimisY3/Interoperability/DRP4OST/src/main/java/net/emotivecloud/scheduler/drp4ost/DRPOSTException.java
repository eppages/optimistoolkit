...
/**
 * Class
 * <code>DRPException</code> An exception specially built to get the error
 * condition back to the client.
 *
 * @author <a href="mailto:saint@eng.it">Gian Uberto Lauri</a>
 * @version $Revision$
 */
public class DRPOSTException extends WebApplicationException {
     ...
     * <code>DRPException</code> .
     *
     */
    public DRPOSTException() {
        super();
    }
     ...
     * remote client
     */
    public DRPOSTException(int status) {
        super(status);
    }
     ...
     * the remote client
     */
    public DRPOSTException(Response response) {
        super(response);
    }
     ...
     * remote client
     */
    public DRPOSTException(Status status) {
        super(status);
    }
     ...
     * the remote client
     */
    public DRPOSTException(Throwable cause, int status) {
    ...
    /**
     * Creates a new instance of
     * <code>DRPException</code>. This is to mimick standard Java Exceptions.
     *
     * @param message a <code>String</code> exception message
     * @param status an <code>int</code> the HTTP status code to be returned to
     * the remote client
     */
    public DRPOSTException(String message, int status) {
     ...
     * remote client
     */
    public DRPOSTException(Throwable cause, Status status) {
     ...
     */
    public DRPOSTException(String message, Throwable cause, int status) {
