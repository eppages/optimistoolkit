 ...
 * @author greig
 */
public class GraphicReportACDiagramPanel extends ContentPanel {

    public GraphicReportACDiagramPanel() {
        setHeading(Constants.MENU_AC_NAME);
        setLayout(new FitLayout());

        IPManagerWebServiceAsync service = (IPManagerWebServiceAsync) Registry.get("guiservice");
        service.getACUrl(new AsyncCallback<String>() {
