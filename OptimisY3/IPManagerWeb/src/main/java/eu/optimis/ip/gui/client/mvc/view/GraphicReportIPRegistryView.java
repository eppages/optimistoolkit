...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicIPRegistryReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportIPRegistryView extends View {

    private ContentPanel graphicReport;

    public GraphicReportIPRegistryView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicIPRegistryReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.IPRegistry, null);
                return;
            }
        });
