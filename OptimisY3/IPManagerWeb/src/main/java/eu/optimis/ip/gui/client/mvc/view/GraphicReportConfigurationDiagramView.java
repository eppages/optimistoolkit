...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicReportConfigurationDiagramPanel;
 ...
 * @author greig
 */
public class GraphicReportConfigurationDiagramView extends View {

    private LayoutContainer container;
    private GraphicReportConfigurationDiagramPanel grdp;

    public GraphicReportConfigurationDiagramView(Controller controller) {
        super(controller);
    }
    ...
    protected void handleEvent(AppEvent event) {
        ...
        if (event.getType() == MainEvents.CONFIGURATION) {
    ...
    protected void initialize() {
        ...
        grdp = new GraphicReportConfigurationDiagramPanel();
