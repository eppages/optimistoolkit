...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicACReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportACView extends View {

    private ContentPanel graphicReport;

    public GraphicReportACView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicACReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.AC, null);
