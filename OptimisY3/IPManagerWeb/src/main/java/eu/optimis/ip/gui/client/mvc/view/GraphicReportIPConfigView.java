...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicIPConfigReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportIPConfigView extends View {

    private ContentPanel graphicReport;

    public GraphicReportIPConfigView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicIPConfigReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.IP_CONFIG, null);
                return;
            }
        });
