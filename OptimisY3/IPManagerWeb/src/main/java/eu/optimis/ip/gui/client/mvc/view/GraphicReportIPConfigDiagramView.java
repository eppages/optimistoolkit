 ...
 * @author greig
 */
public class GraphicReportIPConfigDiagramView extends View {

    private LayoutContainer container;
    private GraphicReportIPConfigDiagramPanel grdp;

    public GraphicReportIPConfigDiagramView(Controller controller) {
        super(controller);
    }
    ...
    protected void handleEvent(AppEvent event) {
        ...
        if (event.getType() == MainEvents.IP_CONFIG) {
    ...
    protected void initialize() {
        ...
        grdp = new GraphicReportIPConfigDiagramPanel();
