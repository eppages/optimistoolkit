...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicReportIPRegistryDiagramPanel;
 ...
 * @author greig
 */
public class GraphicReportIPRegistryDiagramView extends View {

    private LayoutContainer container;
    private GraphicReportIPRegistryDiagramPanel grdp;

    public GraphicReportIPRegistryDiagramView(Controller controller) {
        super(controller);
    }
    ...
    protected void initialize() {
        ...
        grdp = new GraphicReportIPRegistryDiagramPanel();
