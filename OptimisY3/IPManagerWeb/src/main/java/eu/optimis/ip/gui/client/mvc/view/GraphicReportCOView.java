 ...
 * @author greig
 */
public class GraphicReportCOView extends View {

    private ContentPanel graphicReport;

    public GraphicReportCOView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicCOReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.CO, null);
                return;
            }
        });
