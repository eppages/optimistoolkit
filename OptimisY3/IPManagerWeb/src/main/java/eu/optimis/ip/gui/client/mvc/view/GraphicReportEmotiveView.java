...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicEmotiveReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportEmotiveView extends View {

    private ContentPanel graphicReport;

    public GraphicReportEmotiveView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicEmotiveReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.EMOTIVE, null);
