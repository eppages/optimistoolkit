...
import eu.optimis.ip.gui.client.mvc.view.GraphicReportCODiagramView;
import eu.optimis.ip.gui.client.mvc.view.GraphicReportCOView;
 ...
 * @author greig
 */
public class COController extends Controller {

    private GraphicReportCOView reportView;
    private GraphicReportCODiagramView grdView;

    public COController() {
        registerEventTypes(MainEvents.Init);
        registerEventTypes(MainEvents.CO);
    ...
    public void initialize() {
        super.initialize();
        reportView = new GraphicReportCOView(this);
        grdView = new GraphicReportCODiagramView(this);
    }
}
