...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicDMReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportDMView extends View {

    private ContentPanel graphicReport;

    public GraphicReportDMView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicDMReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.DM, null);
