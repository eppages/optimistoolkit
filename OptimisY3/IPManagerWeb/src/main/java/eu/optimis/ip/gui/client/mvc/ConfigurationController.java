...
import eu.optimis.ip.gui.client.mvc.view.*;
...
public class ConfigurationController extends Controller {
    ...
    private GraphicReportConfigurationView reportView;
    private GraphicReportConfigurationDiagramView grdView;

    public ConfigurationController() {
        registerEventTypes(MainEvents.Init);
        registerEventTypes(MainEvents.CONFIGURATION);
    ...
    public void handleEvent(AppEvent event) {
        ...
        if (type == MainEvents.CONFIGURATION) {
    ...
    public void initialize() {
        super.initialize();
        reportView = new GraphicReportConfigurationView(this);
        grdView = new GraphicReportConfigurationDiagramView(this);
    }
}
