...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicTRECReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportTRECView extends View {

    private ContentPanel graphicReport;

    public GraphicReportTRECView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicTRECReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.TREC, null);
