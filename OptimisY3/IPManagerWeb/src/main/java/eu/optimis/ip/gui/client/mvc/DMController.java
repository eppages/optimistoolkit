...
import eu.optimis.ip.gui.client.mvc.view.GraphicReportDMDiagramView;
import eu.optimis.ip.gui.client.mvc.view.GraphicReportDMView;
...
public class DMController extends Controller {
    ...
    private GraphicReportDMView reportView;
    private GraphicReportDMDiagramView grdView;

    public DMController() {
        registerEventTypes(MainEvents.Init);
        registerEventTypes(MainEvents.DM);
    ...
    public void initialize() {
        super.initialize();
        reportView = new GraphicReportDMView(this);
        grdView = new GraphicReportDMDiagramView(this);
    }
}
