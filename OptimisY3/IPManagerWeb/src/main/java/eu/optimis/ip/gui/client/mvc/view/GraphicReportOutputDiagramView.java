...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicReportOutputDiagramPanel;
 ...
 * @author greig
 */
public class GraphicReportOutputDiagramView extends View {

    private LayoutContainer container;
    private GraphicReportOutputDiagramPanel grdp;

    public GraphicReportOutputDiagramView(Controller controller) {
        super(controller);
    }
    ...
    protected void handleEvent(AppEvent event) {
        ...
        if (event.getType() == MainEvents.Output) {
    ...
    protected void initialize() {
        ...
        grdp = new GraphicReportOutputDiagramPanel();
