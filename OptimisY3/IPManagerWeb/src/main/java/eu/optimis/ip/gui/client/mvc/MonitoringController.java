...
import eu.optimis.ip.gui.client.mvc.view.GraphicReportMonitoringDiagramView;
import eu.optimis.ip.gui.client.mvc.view.GraphicReportMonitoringView;
...
public class MonitoringController extends Controller {
    ...
    private GraphicReportMonitoringView reportView;
    private GraphicReportMonitoringDiagramView grdView;

    public MonitoringController() {
        registerEventTypes(MainEvents.Init);
        registerEventTypes(MainEvents.Monitoring);
    ...
    public void initialize() {
        super.initialize();
        reportView = new GraphicReportMonitoringView(this);
        grdView = new GraphicReportMonitoringDiagramView(this);
    }
}
