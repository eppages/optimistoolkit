 ...
 * @author greig
 */
public class GraphicReportMonitoringDiagramPanel extends ContentPanel {

    public GraphicReportMonitoringDiagramPanel() {
        setHeading(Constants.MENU_MONITORING_NAME);
        setLayout(new FitLayout());

        IPManagerWebServiceAsync service = (IPManagerWebServiceAsync) Registry.get("guiservice");
        service.getMonitoringUrl(new AsyncCallback<String>() {
