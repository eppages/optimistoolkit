...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicMonitoringReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportMonitoringView extends View {

    private ContentPanel graphicReport;

    public GraphicReportMonitoringView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicMonitoringReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.Monitoring, null);
