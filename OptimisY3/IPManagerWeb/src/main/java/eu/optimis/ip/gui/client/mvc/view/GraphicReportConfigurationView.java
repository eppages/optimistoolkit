...
import eu.optimis.ip.gui.client.userwidget.graph.GraphicCOReportPanel;
import eu.optimis.ip.gui.client.userwidget.graph.GraphicConfigurationReportPanel;

/**
 *
 * @author greig
 */
public class GraphicReportConfigurationView extends View {

    private ContentPanel graphicReport;

    public GraphicReportConfigurationView(Controller controller) {
        super(controller);
    }
    ...
    private void initUI() {
        graphicReport = new GraphicConfigurationReportPanel();
        ...
        graphicReport.addListener(Events.Expand, new Listener<ComponentEvent>() {
            ...
            public void handleEvent(ComponentEvent be) {
                ...
                wrapper.removeAll();
                Dispatcher.get().dispatch(MainEvents.CONFIGURATION, null);
                return;
            }
        });
