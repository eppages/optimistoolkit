...
public interface DataAccess {
    ...
    DataAccessId registerDataAccess(AccessParams accesses)  throws IOException;

    //Accessed by task
    List<DataAccessId> registerDataAccesses(List<AccessParams> accesses, int readerMethodId)  throws IOException;
}
