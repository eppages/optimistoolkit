...
public interface FileTransfer {
	...
	void transferBackResultFiles(List<ResultFile> resFiles, TransferBackResultFilesRequest request);

	void transferFileForOpen(DataAccessId faId, Location targetLocation, TransferFileForOpenRequest request);

	void transferFileRaw(DataAccessId faId, Location targetLocation, TransferFileRawRequest request);

	void deleteIntermediateFiles(DeleteIntermediateFilesRequest request);
