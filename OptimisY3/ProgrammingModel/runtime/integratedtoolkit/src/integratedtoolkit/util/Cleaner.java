...
public class Cleaner {
     ...
     * queues it constructs a new Cleaner Dipatcher which is in charge of the
     ...
     * the thread pool is destroyed aswell.
     * 
     * 
     * 
     ...
     * run with 
     */
    public Cleaner(URI[] cleanScripts, String[] cleanParams) {
        if (context == null) {
