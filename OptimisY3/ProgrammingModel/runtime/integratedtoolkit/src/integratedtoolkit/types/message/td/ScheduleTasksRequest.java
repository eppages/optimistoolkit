 ...
 */
public class ScheduleTasksRequest extends TDMessage {
    ...
    /**
     * Constructs an empty ScheduleTaskRequest object
     */
    public ScheduleTasksRequest() {
        super(TDMessageType.SCHEDULE_TASKS);
    }
     ...
     * already be executed
     *
     * @param how many tasks per core are waiting to the end of a task which can
     * already be executed
     */
