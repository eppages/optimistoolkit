 ...
 * worker
 */
public class TransferObjectRequest extends TDMessage {
    ...
    public TransferObjectRequest(){
        super(TDMessageType.TRANSFER_OBJECT);
    }
     ...
     */
    public TransferObjectRequest(DataAccessId daId, String path) {
        super(TDMessageType.TRANSFER_OBJECT);
        this.daId = daId;
        this.path = path;
    }
