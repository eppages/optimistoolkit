 ...
 * end.
 */
public class NewWaitingTaskRequest extends TDMessage {
    ...
    /**
     * Contructs an empty NewWaitingTaskRequest
     *
     */
    public NewWaitingTaskRequest() {
        super(TDMessageType.NEW_WAITING_TASK);
    }
