...
public class DataInstanceId implements Serializable, Comparable<DataInstanceId> {
    ...
    public static int getDataId(String renaming) {
        int pos = renaming.indexOf("v");
        return Integer.parseInt(renaming.substring(1, pos));
    }

    public static int getVersionId(String renaming) {
        int initPos = renaming.indexOf("v") + 1;
        int endPos = renaming.indexOf("_");
        return Integer.parseInt(renaming.substring(initPos, endPos));
    }
