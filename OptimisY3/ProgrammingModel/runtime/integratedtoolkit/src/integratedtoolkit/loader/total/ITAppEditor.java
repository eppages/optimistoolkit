...
public class ITAppEditor extends ExprEditor {
    ...
    public ITAppEditor(Method[] remoteMethods, CtMethod[] instrCandidates, String itApiVar, String itExeVar, String itSRVar, String itORVar) {
        super();
    ...
    public void setAppId(String itAppIdVar) {
        ...
        if (declaredMethod != null) { // Current method must be executed remotely, change the call
            ...
            if (numParams == 0) {
                ...
                if (tracing) {
                    ...
                    executeTask.append(appNameParam)
                            .append(',').append(slaIdParam)
                            .append(',').append(urNameParam)
                            .append(',').append(primaryHostParam)
                            .append(',').append(transferIdParam);
                }
                ...
                if (!isVoid) {
                    ...
                    if (retType.isPrimitive()) {
                        ...
                        if (typeName.equals(boolean.class.getName())) {
                            retValueCreation += "new Boolean(Boolean.FALSE);";
                            cast = "(Boolean)";
                        ...
                        if (typeName.equals(Boolean.class.getName())) {
                            executeTask.insert(0, "$_ = new Boolean(Boolean.FALSE);");
