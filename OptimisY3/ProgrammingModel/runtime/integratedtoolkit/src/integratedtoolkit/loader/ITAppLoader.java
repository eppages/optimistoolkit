...
public class ITAppLoader {
    ...
    /**
     * Factored out loading function so that subclasses of ITAppLoader can
     * re-use this code
     *
     * @param chosenLoader
     * @param appName
     *
     */
    protected static void load(String chosenLoader, String classPath, String appName, String[] appArgs)
            throws Exception {
        ...
        // Set the classpath for the worker
        System.setProperty(ITConstants.IT_WORKER_CP, classPath);
