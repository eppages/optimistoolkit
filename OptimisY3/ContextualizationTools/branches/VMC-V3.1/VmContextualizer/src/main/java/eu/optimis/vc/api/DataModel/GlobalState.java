...
public class GlobalState {
	...
	private HashMap<String, ProgressData> progressDataHashMap;
	private boolean recontextRunning = false; // TODO improve this, maybe return
												// an object

	/**
	 * Default constructor that creates a {@link ProgressData} {@link HashMap}
	...
	/**
	 * Set the manifest to be returned through the API via a services associated
	 * ProgressData object.
	 * 
	 * @param manifest
	 *            The manifest to return.
	 */
	public void setManifest(Manifest manifest) {
		progressDataHashMap.get(manifest.getManifestId()).setManifest(manifest);
	}
