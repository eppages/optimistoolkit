...
public interface LibvirtControlBridgeMBean {
	 ...
	 */
	public abstract void attachIso(String domainName, String isoPath,
	 ...
	 */
	public abstract void detachIso(String domainName, String interfaceName)
	 ...
	 */
	public abstract String getExistingIsoPath(String domainName,
			String interfaceName) throws LibvirtException;
