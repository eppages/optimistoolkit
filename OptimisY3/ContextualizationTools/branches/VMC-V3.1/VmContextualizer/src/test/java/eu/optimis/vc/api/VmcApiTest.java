	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			if (Integer.parseInt(args[0]) == 1) { // Unit Tests (Option 1)
				...
				if (args.length == 4) {
					log.info("Using working directory: " + args[1]); 
					log.info("Using Hypervisor URI: " + args[2]); //TODO at some point put/get this in the properties file
					log.info("Using VM Name: " + args[3]); //TODO at some point put/get this in the properties file
					vmcApiRecontextTest.recontextualize(configFilePath, true, args[2], args[3]);
				} else {
