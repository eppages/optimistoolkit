...
import eu.optimis.mi.gui.client.userwidget.graph.GraphicCostReportPanel;

public class GraphicReportCostView extends View {

	private ContentPanel graphicReport;
	public GraphicReportCostView(Controller controller) {
		super(controller);
	}
	...
	private void initUI(){
		graphicReport = new GraphicCostReportPanel();
