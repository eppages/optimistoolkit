...
import eu.optimis.mi.gui.client.userwidget.graph.GraphicTrustReportPanel;

public class GraphicReportTrustView extends View {

	private ContentPanel graphicReport;
	public GraphicReportTrustView(Controller controller) {
		super(controller);
	}
	...
	private void initUI(){
		graphicReport = new GraphicTrustReportPanel();
