...
public class GraphicCostSPReportController extends Controller {

	private GraphicReportCostView reportView;
	private GraphicReportCostSPDiagramView grdView;
	
	public GraphicCostSPReportController(){
	...
	public void handleEvent(AppEvent event) {
	 ...
	 public void initialize() {
		 ...
		 grdView = new GraphicReportCostSPDiagramView(this);
