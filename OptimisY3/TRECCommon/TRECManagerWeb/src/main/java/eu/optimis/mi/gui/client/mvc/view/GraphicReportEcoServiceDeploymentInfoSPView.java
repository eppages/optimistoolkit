...
import eu.optimis.mi.gui.client.userwidget.graph.GraphicReportEcoServiceDeploymentInfoSPPanel;
 ...
 * @author jsubirat
 */
public class GraphicReportEcoServiceDeploymentInfoSPView extends View {

	
	private LayoutContainer container;
	private GraphicReportEcoServiceDeploymentInfoSPPanel grEcoSDInfoPanel;
        
	
	public GraphicReportEcoServiceDeploymentInfoSPView(Controller controller) {
		super(controller);
	}
	...
	protected void initialize() {
		...
		grEcoSDInfoPanel = new GraphicReportEcoServiceDeploymentInfoSPPanel();
	...
	protected void handleEvent(AppEvent event) {
            ...
            if (event.getType() == MainEvents.ReportGraphicEcoServiceDeploymentInfoSP) {
