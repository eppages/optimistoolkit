...
public class DsBpas {
			...
			DsAhpProviderObject[] providers)
	{
		...
		for(Integer key : prefMap.keySet())
		{
			...
			{
				Set<DsAhpProviderObject> tempSet = new HashSet<DsAhpProviderObject>();
				tempSet = bpaMap.get(currBpa);
		...
		Set<DsAhpProviderObject> frameOfDiscernment = new HashSet<DsAhpProviderObject>();
