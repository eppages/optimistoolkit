 ...
 *
 */
public class forcastVMDepKnown {

    protected static Logger log = Logger.getLogger(InfrastructureProviderRiskAssessmentServer.class);

    public static double[] calc(String replicationFactor, String VMID, String destNode) throws SQLException {
        ...
        log.info("riskFinal before " + riskFinal[0] + " , " + riskFinal[1] + " , " + riskFinal[2] + " , " + riskFinal[3] + " , " + riskFinal[4]);
        log.info("in deployment known class ");
        log.info("sending riskFinal " + riskFinal[0] + " , " + riskFinal[1] + " , " + riskFinal[2] + " , " + riskFinal[3] + " , " + riskFinal[4]);
        return riskFinal;
    }
