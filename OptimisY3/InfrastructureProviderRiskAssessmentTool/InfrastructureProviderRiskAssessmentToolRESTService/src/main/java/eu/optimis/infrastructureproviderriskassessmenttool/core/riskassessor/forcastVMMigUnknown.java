 ...
 *
 */
public class forcastVMMigUnknown {
// we dont know the destination so need to take the average risk of the physical hosts in the IP

    protected static Logger log = Logger.getLogger(InfrastructureProviderRiskAssessmentServer.class);

    public static double[] calc(String replicationFactor, String VMID)
