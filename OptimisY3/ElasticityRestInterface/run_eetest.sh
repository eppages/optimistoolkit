...
JARFILEDIR=target
JARFILENAMEPATTERN=ElasticityEngineREST-0.0.1-SNAPSHOT-jar-with-dependencies.jar
...
echo $FULLMANIFESTPATH

#echo "Full manifestpath: $FULLMANIFESTPATH"

#Execute the default target of the jar file
java -DfakeMonitoring=false -Dlowrisk=$LOWRISK -Dlog4j.configuration=log4j_silent.properties -jar $FILE $FULLMANIFESTPATH
