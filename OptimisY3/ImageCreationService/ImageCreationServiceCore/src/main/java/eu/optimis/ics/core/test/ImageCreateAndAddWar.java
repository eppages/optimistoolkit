/* $Id: ImageCreateAndAddWar.java 4959 2012-03-15 14:00:54Z rkuebert $ */
...
public class ImageCreateAndAddWar extends BaseClient {

	public ImageCreateAndAddWar() {
		...
		putWarAndWait("/home/roland/Desktop/ServiceManager.war", image);
		
		System.out.printf("Image service now contains %d images\n", getNumImages());
	}
	
	public static void main(String[] args) {
		new ImageCreateAndAddWar();
	}
