/* $Id: OrchestrationElement.java 11131 2013-01-24 15:20:20Z sulistio $ */
...
public class OrchestrationElement extends Image {
    ...
    public OrchestrationElement() throws IOException, OutOfDiskSpaceException {
        super();
        ...
        //String imageFilename = rb.getString(Constants.ORCHESTRATION_IMAGE_NAME_PROPERTY);

        PropertiesConfiguration config = PropertiesReader.getPropertiesConfiguration(Constants.ICS_CONFIG_FILE);
        String imageFilename = config.getString(Constants.ORCHESTRATION_IMAGE_NAME_PROPERTY);
        baseImageFile = new File(super.imageDirectory + "/" + imageFilename);

        cloneImage();
    }

    public OrchestrationElement(String imageFilename) throws IOException, OutOfDiskSpaceException {
        super();
