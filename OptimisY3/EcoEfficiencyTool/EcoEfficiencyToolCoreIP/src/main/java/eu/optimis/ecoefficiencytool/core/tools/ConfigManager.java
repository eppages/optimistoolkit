...
public class ConfigManager {
    ...
    public static final String ECO_CONFIG_FILE = "/etc/EcoEfficiencyToolIP/config.properties";
    public static final String ENERGY_SOURCES_CONFIG_FILE = "/etc/EcoEfficiencyToolIP/energysources.properties";
    public static final String LOG4J_CONFIG_FILE = "/etc/EcoEfficiencyToolIP/log4jECO.properties";
    public static final String ENERGYCREDITS_CONFIG_FILE = "/etc/EcoEfficiencyToolIP/energycredits.properties";
    public static final String IPDDBB_CONFIG_FILE = "/etc/EcoEfficiencyToolIP/hibernateIP.cfg.xml";
