 ...
 * 02111-1307 USA
 */
package eu.optimis.ecoefficiencytool.trecdb.ip.utils;
...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            String path = optimisHome +"/etc/EcoEfficiencyToolIP/hibernateIP.cfg.xml";
            ...
            if(hibernateConfig.exists()) {
                ...
                //Used for testing.
                URL hibernateConfigIP = HibernateUtil.class.getResource("/hibernateIP.cfg.xml");
